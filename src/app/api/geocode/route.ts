  ...
  try {
    ...
    if (lat !== null && lng !== null) {
      ...
      if (apiKey && apiKey.trim() !== '' && !apiKey.includes('your-google-maps')) {
        ...
        if (googleData.results && googleData.results.length > 0) {
          ...
          return NextResponse.json({
            ...
            city: locality || sublocality || 'Local City',
            pincode: pincode || '',
            source: 'google_maps',
          });
        }
      ...
      if (osmRes.ok) {
        ...
        const city = addr.city || addr.town || addr.village || addr.county || 'SRR Area';
    ...
    return NextResponse.json({
      ...
      formatted_address: 'Market Main Road, Local Area',
      city: 'Local Area',
      pincode: '',
    ...
    return NextResponse.json(
      {
        ...
        latitude: lat || 17.385044,
        longitude: lng || 78.486671,
        formatted_address: 'Main Market Area',
        city: 'Local Area',
        pincode: '',
      },
      { status: 500 }
